...
def load_dataset(path, split=0.1):
    train_x = sorted(glob(os.path.join(path, "train", "_blurred_image", "*.jpg")))
    train_y = sorted(glob(os.path.join(path, "train", "_mask", "*.png")))

    valid_x = sorted(glob(os.path.join(path, "validation", "P3M-500-NP", "_original_image", "*.jpg")))
    valid_y = sorted(glob(os.path.join(path, "validation", "P3M-500-NP", "_mask", "*.png")))
...
if __name__ == "__main__":
    ...
    dataset_path = "Image-Segmentation/P3M-10k"
